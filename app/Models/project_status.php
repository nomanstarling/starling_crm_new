...
class project_status extends Model
{
    ...
    public function getSalesListings(){
        return $this->hasMany(Listings::class, 'project_status_id')->where(function ($query) {
    ...
    {
        return $this->hasMany(Listings::class, 'project_status_id')->withTrashed()->where(function ($query) {
