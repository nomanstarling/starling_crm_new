...
(async () => {
  ...
  const browser = await puppeteer.launch({headless: "new", ignoreHTTPSErrors: true, args: ['--no-sandbox', '--no-quarantine', '--disable-setuid-sandbox'], executablePath: '/opt/homebrew/bin/chromium'});
